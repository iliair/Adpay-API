...
<div class="row">
    ...
    <div class="card mr_bottom20 mr_top10">
     ...
     <div class="title">جمع ویدئو ها</div>
      ...
      <ul>
        ...
        <li><a href="manage_user_history_withdrawal.php?user_id=<?php echo $users_res_row['id'];?>" style="color: #e91e63;">درخواست ها</a></li>
    ...
    <thead>
        <tr>
            <tr>
              ...
              <th style="width:110px;">وضعیت فعلی</th>  
           </tr>
        </tr>
    </thead>
    <tbody>
    ...
    ?>
        <tr>
           ...
           <td>
               <span class="badge badge-success badge-icon"><i class="fa fa-clock-o" aria-hidden="true"></i><span><?php echo jdate('Y/m/d', strtotime($users_withdrawal['request_date'])).' - '.jdate('h:i A', strtotime($users_withdrawal['request_date']));?> </span></span>
          </td>
          <td>
                  <?php if($users_withdrawal['status']=="1"){?>
                  <span class="badge badge-success badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>پرداخت شده</span></span>

                <?php }else if($users_withdrawal['status']=="2"){?>
                  <span class="badge badge-danger badge-icon"><i class="fa fa-ban" aria-hidden="true"></i><span>رد شده </span></span>
                   
                  <?php }else{?>
                  <span class="badge badge-danger badge-icon"><i class="fa fa-clock-o" aria-hidden="true"></i><span>در انتظار </span></span>
                  <?php }?>
