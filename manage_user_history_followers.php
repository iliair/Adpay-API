...
$total_pending = $total_pending['num'];				
    ...
    WHERE tbl_follows.user_id='".$_GET['user_id']."' ORDER BY tbl_follows.id DESC LIMIT $start, $limit";
...
<div class="row">
    ...
    <div class="card mr_bottom20 mr_top10">
      ...
      <ul>
        ...
        <li><a href="manage_user_history_followers.php?user_id=<?php echo $users_res_row['id'];?>" style="color: #e91e63;"><?php echo $users_res_row['total_followers'];?> دنبال کننده</a></li>
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="col-md-5 col-xs-12">
          <div class="page_title">دنبال کنندگان</div>
        </div>
        </div>
          ...
          <div class="col-md-3">
            <div class="user_followings_block">
              ...
              <?php if(get_user_info($row_follow['follower_id'],'user_image')!="") {?>
                    <img src="images/<?php echo get_user_info($row_follow['follower_id'],'user_image');?>" alt="user_photo" style="width: 225px;height: 225px" />
              <?php }else{?>  
                    <img src="assets/images/user_photo.png" alt="user_photo" />
              <?php } ?>  
 
              <h3><?php echo get_user_info($row_follow['follower_id'],'name');?></h3>
              <a href="manage_user_history.php?user_id=<?php echo $row_follow['follower_id'];?>" class="view_more_info">مشاهده اطلاعات</a>
            </div>
          </div>
          <?php
