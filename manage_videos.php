        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">مدیریت ویدئو ها</div>
            </div>
            <div class="col-md-7 col-xs-12">
              ...
              <div class="search_list">
                ...
                <form method="GET" name="myform" action="">
                  <div class="search_block col-md-12">                   
                    <select name="video_status" id="video_status" class="select2" required>
                        ...
                        <option value="2" <?php if(isset($_GET['video_status']) AND $_GET['video_status']==2){?>selected<?php }?>>ویدئو افقی</option>
                        <option value="3" <?php if(isset($_GET['video_status']) AND $_GET['video_status']==3){?>selected<?php }?>>ویدئو عمودی</option>                     
                    </select>                   
                  </div> 
                </form>
                ...
                <div class="add_btn_primary"> <a href="add_video.php">اضافه کردن ویدئو</a> </div>
              </div>
            </div>           
          </div>		
          ...
          <button type="submit" class="btn btn-primary" name="delete_rec" value="delete_wall" onclick="return confirm('آیا میخواهید همه ی موارد را حذف نمایید؟');">حذف</button>                  </div>               </div>            </div>
                ...
                <div class="block_wallpaper">
                  <div class="wall_category_block">
                    ...
                    <?php if($row['featured']!="0"){?>
                         <a href="manage_videos.php?featured_deactive_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="حذف از اسلایدر"><div style="color:green;"><i class="fa fa-check-circle"></i></div></a> 
                      <?php }else{?>
                         <a href="manage_videos.php?featured_active_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="افزودن به اسلایدر"><i class="fa fa-circle"></i></a> 
                      <?php }?>
                  ...
                  <div class="wall_image_title">
                     ...
                     <p>ارسال شده توسط مدیر</p>
                    <ul>
                      <?php if($row['video_layout']=='Portrait'){?>
                        <li><a href="javascript:void(0)" data-toggle="tooltip" data-tooltip="عمودی"><i class="fa fa-mobile"></i></a></li>
                      <?php }else{?>
                        <li><a href="javascript:void(0)" data-toggle="tooltip" data-tooltip="افقی"><i class="fa fa-mobile" style="transform:rotate(90deg);"></i></a></li>
                      <?php }?>  
                      ...
                      <?php if($row['status']!="0"){?>
                       <li><div class="row toggle_btn"><a href="manage_videos.php?status_deactive_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="غیرفعال کردن"><img src="assets/images/btn_enabled.png" alt="wallpaper_1" /></a></div></li> 

                      <?php }else{?>
                      
                       <li><div class="row toggle_btn"><a href="manage_videos.php?status_active_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="فعال کردن"><img src="assets/images/btn_disabled.png" alt="wallpaper_1" /></a></div></li> 
